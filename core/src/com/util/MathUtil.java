...
public class MathUtil {
        ...
        /**
         * Given a wedge number and ring number and a monster number, determine the
         * y coordinate where to draw the monster. Assuming origin top left corner,
         ...
         * a negative coordinate, or if scaleCoeff is nonpositive, or if
         * monsterNumber is less than 1.
         */
        public static int yCoord(int wedge, int ring, int monsterNumber, int castleCenterX, int castleCenterY, double scaleCoeff) {
            ...
            finalX = (int) ((startX + mult * deltaX) * scaleCoeff);
            finalY = (int) ((startY + mult * deltaY) * scaleCoeff);
        ...
        /**
         * Given a wedge number and ring number and a monster number, determine the
         * x coordinate where to draw the monster. Assuming origin top left corner,
         * positive y axis down.
         *
         * @param wedge Desired wedge number. Must be 1, 2, 3, 4, 5, or 6.
         * @param ring Desired ring number. Must 1 for castle, 2 for swordsman, 3
